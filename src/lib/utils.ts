...
export const fileExists = (path: string, basePath = CWD) => exists(resolve(basePath, path));
...
export const readYaml = async <T>(decoder: d.Decoder<unknown, T>, path: string, basePath?: string): Promise<T> => {
